    ...
    <main id="main-container">
        ...
        <div class="content">
            ...
            <div class="block block-rounded block-fx-shadow">
                <div class="block-content">
                    <form method="post" action="{{ route('sto.store') }}" enctype="multipart/form-data"><!-- Photos -->
                        ...
                        <div class="row items-push">
                            ...
                            <div class="col-lg-7 offset-lg-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="re-listing-name"
                                           list="town" name="town" autocomplete="off">
                                    <datalist id="town">
                                        @foreach($town as $t)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" onclick="var input = document.getElementById('start_hour_monday'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}
                                                   ...
                                                   type="checkbox"  name="monday" value="monday" id="monday" checked>
                                        ...
                                        <input class="form-control form-control-lg " id="start_hour_monday" type="time"
                                               value="09:00"
                                        ...
                                        <input class="form-control form-control-lg" type="time" value="18:00"
                                               name="end_hour_monday" id="end_hour_monday" disabled="disabled">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" onclick="var input = document.getElementById('start_hour_tuesday'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}
                                                   ...
                                                   type="checkbox" name="tuesday" value="tuesday" id="tuesday" checked>
                                            <label class="form-check-label" for="tuesday">
                                                Вихідний
                                            </label>
                                        </div>
                                        <label for="re-listing-name">Година відкриття</label>
                                        <input class="form-control form-control-lg " id="start_hour_tuesday" type="time"
                                               value="09:00"
                                               name="start_hour_tuesday" disabled="disabled">
                                        <label for="re-listing-name">Година закриття</label>
                                        <input class="form-control form-control-lg" type="time" value="18:00"
                                               name="end_hour_tuesday" id="end_hour_tuesday" disabled="disabled">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" onclick="var input = document.getElementById('start_hour_wednesday'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}
                                                   ...
                                                   type="checkbox" name="wednesday" value="wednesday" id="wednesday" checked>
                                        ...
                                        <label for="re-listing-name">Година відкриття</label>
                                        <input class="form-control form-control-lg " id="start_hour_wednesday" type="time"
                                               value="09:00"
                                               name="start_hour_wednesday" disabled="disabled">
                                        <label for="re-listing-name">Година закриття</label>
                                        <input class="form-control form-control-lg" type="time" value="18:00"
                                               name="end_hour_wednesday" id="end_hour_wednesday" disabled="disabled">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" onclick="var input = document.getElementById('start_hour_thursday'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}
                                                   ...
                                                   type="checkbox" name="thursday" value="thursday" id="thursday" checked>
                                        ...
                                        <label for="re-listing-name">Година відкриття</label>
                                        <input class="form-control form-control-lg " id="start_hour_thursday" type="time"
                                               value="09:00"
                                               name="start_hour_thursday" disabled="disabled">
                                        <label for="re-listing-name">Година закриття</label>
                                        <input class="form-control form-control-lg" type="time" value="18:00"
                                               name="end_hour_thursday" id="end_hour_thursday" disabled="disabled">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" onclick="var input = document.getElementById('start_hour_friday'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}
                                                   ...
                                                   type="checkbox" name="friday" value="friday" id="friday" checked>
                                        ...
                                        <label for="re-listing-name">Година відкриття</label>
                                        <input class="form-control form-control-lg " id="start_hour_friday" type="time"
                                               value="09:00"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" onclick="var input = document.getElementById('start_hour_saturday'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}
                                                   ...
                                                   type="checkbox" name="saturday" value="saturday" id="defaultCheck2" checked>
                                        ...
                                        <label for="re-listing-name">Година відкриття</label>
                                        <input class="form-control form-control-lg " id="start_hour_saturday" type="time"
                                               value="09:00"
                                               name="start_hour_saturday" disabled="disabled">
                                        <label for="re-listing-name">Година закриття</label>
                                        <input class="form-control form-control-lg" type="time" value="18:00"
                                               name="end_hour_saturday" id="end_hour_saturday" disabled="disabled">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" onclick="var input = document.getElementById('start_hour_sunday'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}
                                                   ...
                                                   type="checkbox" name="sunday" value="sunday" id="defaultCheck1" checked>
                                        ...
                                        <label for="re-listing-name">Година відкриття</label>
                                        <input class="form-control form-control-lg " id="start_hour_sunday" type="time"
                                               value="09:00"
