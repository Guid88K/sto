        ...
        <div class="sidebar-content">
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    <li>
                        <a href="{{url('/admin/sto/create')}}"><i class="si si-plus"></i><span class="sidebar-mini-hide">Add sto</span></a>
                    </li>
                </ul>
            </div>
            <!-- END Side Navigation -->
        ...
        <div class="content">
            <div class="row gutters-tiny invisible" data-toggle="appear">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block text-center" href="{{url('/admin/sto')}}">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="{{route('sto_public.show',['id' => $s->id] )}}">
                                        <img class="img-fluid rounded-top" src="{{ asset('upload/'.$s->image)}}" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
                                    <h4 class="font-size-h5 mb-10">{{$s->name}}</h4>
                                    <p class="text-muted">
                                        <i class="fa fa-map-pin mr-5"></i> {{$s->address}}
                                    </p>
                                </div>
                                ...
                                <div class="block-content block-content-full">
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="{{ route('sto.edit', $s->id)}}">
                                                <button type="button" class="btn btn-alt-secondary text-center">Редагувати</button>
                                            </a>
                                        </div>
                                        <div class="col-6">
                                            <form action="{{  route('sto.destroy',$s->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-alt-primary text-center ">Видалити</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
